...
Remove-ContextMenu -BaseSubKey "Software\Classes\*" -KeyName "WeftEndBind"
Remove-ContextMenu -BaseSubKey "Software\Classes\*" -KeyName "WeftEndUnbind"
...
Remove-ContextMenu -BaseSubKey "Software\Classes\lnkfile" -KeyName "WeftEndBind"
Remove-ContextMenu -BaseSubKey "Software\Classes\lnkfile" -KeyName "WeftEndUnbind"
...
Remove-ContextMenu -BaseSubKey "Software\Classes\Directory" -KeyName "WeftEndBind"
Remove-ContextMenu -BaseSubKey "Software\Classes\Directory" -KeyName "WeftEndUnbind"
